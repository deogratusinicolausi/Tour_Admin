...
class _AdminChatDetailScreenState extends State<AdminChatDetailScreen> {
  ...
  Future<void> _markAsRead() async {
    await _service.markMessagesAsRead(widget.chatId);
  }
  ...
  void _watchTyping() {
    FirebaseFirestore.instance
      ...
      if (mounted && doc.exists) {
        setState(() {
          _isUserTyping = doc.data()?['userTyping'] ?? false;
        });
      }
    });
  }
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontStyle:
                      _isUserTyping ? FontStyle.italic : FontStyle.normal,
                    ),
                  ),
                ],
              ),
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    if (i == messages.length && _isUserTyping) {
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) {
                          _service.setTyping(widget.chatId, v.isNotEmpty);
                        },
